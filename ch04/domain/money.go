...
// Money represents a monetary value in the smallest currency
// unit (e.g., cents). Using int64 avoids floating-point
// rounding errors — a domain decision, not an infrastructure
// one.
type Money struct {
	amount   int64
	currency string
